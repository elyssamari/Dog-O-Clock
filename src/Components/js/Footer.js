  ...
  return (
    ...
    <Stack spacing={25} direction="row">
        ...
        <div>
            ...
            <Link 
            sx={{ flexGrow: 1 }} 
            style={{ fontFamily: "Inter", marginLeft: 50, marginBottom: 50, color: 'black', textDecorationColor: 'black'}}>
                https://www.superset.com/ 
            </Link>
        </div>

        <div>
            <Typography variant="h6" sx={{ flexGrow: 1 }} style={{ fontFamily: "Inter", marginLeft: 50, marginRight: 50, marginBottom: 10}}>Sources: </Typography>
            <div className="justify-content-md-center" id="footer-line3"></div>
            <Stack direction={'column'}>
                <Link 
                sx={{ flexGrow: 1 }} 
                style={{ fontFamily: "Inter", marginLeft: 50, marginBottom: 20, marginTop: 50, color: 'black', textDecorationColor: 'black'}}>
                    https://dog.ceo/api/breeds/image/random 
                </Link>
                <Link 
                sx={{ flexGrow: 1 }} 
                style={{ fontFamily: "Inter", marginLeft: 50, marginBottom: 20, color: 'black', textDecorationColor: 'black'}}>
                    https://www.blobmaker.app/
                </Link>
                <Link 
                sx={{ flexGrow: 1 }} 
                style={{ fontFamily: "Inter", marginLeft: 50, marginBottom: 100, color: 'black', textDecorationColor: 'black'}}>
